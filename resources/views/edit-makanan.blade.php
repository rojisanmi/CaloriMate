...
<div class="max-w-2xl mx-auto cm-fadein">
  ...
  <div class="flex items-center gap-3 mb-6">
    ...
    <div>
      <h1 class="font-raleway text-xl font-bold text-[#2E471F]">Edit Makanan</h1>
      <p class="text-xs text-gray-400">{{ $food->name }}</p>
    </div>
  </div>
    ...
    <form method="POST" action="{{ route('trainer.foods.update', $food) }}" class="space-y-5">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        ...
        <div>
          ...
          <input type="number" step="0.01" min="0" max="2000" name="grammage"
                 value="{{ old('grammage', $food->grammage) }}" required
        ...
        <div>
          ...
          <input type="number" step="0.01" min="0" max="5000" name="calories_per_portion"
        ...
        <div>
          ...
          <input type="number" step="0.01" min="0" max="500" name="total_fat"
                 value="{{ old('total_fat', $food->total_fat) }}" required
        ...
        <div>
          ...
          <input type="number" step="0.01" min="0" max="500" name="total_carbo"
                 value="{{ old('total_carbo', $food->total_carbo) }}" required
        ...
        <div>
          ...
          <input type="number" step="0.01" min="0" max="500" name="total_protein"
                 value="{{ old('total_protein', $food->total_protein) }}" required
