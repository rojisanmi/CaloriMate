  ...
  <div class="auth-card rounded-3xl overflow-hidden mx-auto w-full max-w-5xl
    ...
    <div class="bg-white px-8 md:px-10 lg:px-12
      ...
      <div class="w-full max-w-sm">
        ...
        <h2 class="font-raleway text-3xl md:text-4xl font-bold text-[#2E471F] text-center mb-2">
          Login Admin
        </h2>
        <p class="text-center text-sm text-gray-500 mb-6">CaloriMate Administrator</p>
