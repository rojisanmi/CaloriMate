...
<div class="max-w-3xl mx-auto cm-fadein">
  ...
  <form id="edit-program-form" action="{{ route('trainer.programs.update', $program) }}" method="POST" class="space-y-6">
    @csrf @method('PUT')
  ...
  </form>{{-- END edit-program-form --}}

  {{-- ACTIONS (outside edit form to avoid nested-form bug) --}}
  <div class="flex justify-between items-center">
    ...
    <div class="flex gap-3">
      ...
      {{-- form="..." links this button to the edit form even though it lives outside it --}}
