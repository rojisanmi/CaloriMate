...
<section class="relative text-center px-4 sm:px-6 py-6">
    ...
    {{-- ORANGE CURVE TOP --}}
    <div class="absolute -inset-x-8 -top-24 h-40 sm:h-48 bg-[#F4A938] rounded-b-[60%] -z-10"></div>

    {{-- SUMMARY CARD --}}
    <div class="relative z-10 flex justify-center mt-2 pt-6">
    ...
    {{-- ORANGE CURVE BOTTOM --}}
    <div class="absolute -inset-x-8 -bottom-8 sm:-bottom-10 h-16 sm:h-20 bg-[#F4A938] rounded-t-[60%] -z-10"></div>
